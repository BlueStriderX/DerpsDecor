 ...
 */
public class LargeDarkTilesWedge extends Block {
	public LargeDarkTilesWedge() {
		super("Large Dark Tiles Wedge",ElementKeyMap.getInfo(205).getType());
	}
	...
	public void initialize() {
		...
		blockInfo.sourceReference = ElementManager.getInfo("Large Dark Tiles").getId();
		if(GraphicsContext.initialized) {
			try {
				...
				blockInfo.setBuildIconNum(ResourceManager.getTexture("large-dark-tiles-wedge-icon").getTextureId());
