...
public class StorageManager extends InventoryBlock {
    ...
    @Override
    public StorageManagerInventory createInventory(InventoryHolder holder, SegmentPiece segmentPiece) {
    ...
    public void updateInventory(Inventory inventory, SegmentPiece segmentPiece) {
        ...
        ManagerContainer<?> managerContainer = ServerUtils.getManagerContainer(segmentPiece.getSegmentController());
